...
class appProdProjectContainer extends Container
{
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_mysql', 'host' => 'localhost', 'port' => '', 'dbname' => 'boutix', 'user' => 'root', 'password' => '', 'charset' => 'UTF8', 'driverOptions' => array(1002 => 'SET sql_mode=(SELECT REPLACE(@@sql_mode,\'ONLY_FULL_GROUP_BY\',\'\'))'), 'serverVersion' => 5.0999999999999996), new \Doctrine\DBAL\Configuration(), $a, array('enum' => 'string'));
    }
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf2orm_default_8d6989533a74a8c4b58f5cef37065c5d24850165d73229b1c061ca90118cab01');
    ...
    {
        return $this->services['uri_signer'] = new \Symfony\Component\HttpKernel\UriSigner('uecmuDUgKPMFtNrIrwGY41xAjIBDiBD4c4gp0DWYdBsS9MK70uYoH1Qo');
    }
    ...
    {
        $this->services['security.authentication.manager'] = $instance = new \Symfony\Component\Security\Core\Authentication\AuthenticationProviderManager(array(0 => new \Symfony\Component\Security\Core\Authentication\Provider\AnonymousAuthenticationProvider('5a6488d148c338.80237372')), true);
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'secret' => 'uecmuDUgKPMFtNrIrwGY41xAjIBDiBD4c4gp0DWYdBsS9MK70uYoH1Qo',
            'ps_caching' => 'CacheMemcache',
            'ps_cache_enable' => false,
            'ps_creation_date' => '2018-01-19',
            'locale' => 'en-US',
            'cookie_key' => 'bgYwgP7ianDfYhb2hxtw5Q0pFRWtM5PLG5TfNu6hVa7IZwpomAmpVMwJ',
            'cookie_iv' => 'Ke2Hgr0u',
            'new_cookie_key' => 'def000002fb9788b1893e140befe1f38270ed945a14c0323e1ccadc7ffdc92b4bfead0526abb643a06181425b0be34083b41964242000ff63dedb8850d45d11e2a806dbf',
            ...
            'kernel.secret' => 'uecmuDUgKPMFtNrIrwGY41xAjIBDiBD4c4gp0DWYdBsS9MK70uYoH1Qo',
